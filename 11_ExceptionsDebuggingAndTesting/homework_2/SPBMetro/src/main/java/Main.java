...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        inputErrorsLogger = LogManager.getLogger("inputErrorLogger");
        exceptionsLogger = LogManager.getRootLogger();
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            if (station != null) {
                searchLogger.info("Введена станция: " + station);
                return station;
            }
    ...
    private static void createStationIndex() {
        ...
        try
        {
            ...
            exceptionsLogger.error(ex.getMessage());
            ex.printStackTrace();
        }
    }
